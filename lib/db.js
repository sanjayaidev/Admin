...
async function migrate() {
  ...
  // environments with an older/different shape. This ensures any columns the
  // rest of the app relies on are present, even if an earlier migration or
  // manual setup created the table with a different schema.
