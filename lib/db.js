...
async function migrate() {
  ...
  `);
  await pool.query(`CREATE INDEX IF NOT EXISTS idx_sm_connections_user_id ON sm_connections (user_id);`);
  ...
  `);
  await pool.query(`CREATE INDEX IF NOT EXISTS idx_sm_flows_user_id ON sm_flows (user_id);`);
  ...
  await pool.query(`CREATE INDEX IF NOT EXISTS idx_sm_flow_steps_order ON sm_flow_steps (flow_id, order_index);`);
